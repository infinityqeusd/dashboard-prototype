...
export function TickerRibbon({ items }: TickerRibbonProps) {
  ...
  return (
    <section className="px-4 pt-3 sm:px-6 lg:px-8">
      <div className="relative overflow-hidden rounded-2xl border border-slate-200/80 bg-white/80 py-2.5 shadow-panel backdrop-blur-xl dark:border-slate-700/70 dark:bg-slate-950/60 dark:shadow-panel-dark">
